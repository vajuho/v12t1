...
public class MainActivity extends AppCompatActivity {
    ...
    private void updatePoints() {
        int currentPoints = GameManager.getInstance().getPlayer().getScore();
        PlayerScoreText.setText("Pisteet: " + currentPoints);
    }

    public void goToFightMonstersActivity(View view) {
